            ...
            <div className="bg-white rounded-3xl p-6 w-[90%] max-w-md shadow-lg relative">
                ...
                <div className="flex justify-center mb-4">
                    <div className="cursor-pointer w-16 h-16 flex items-center justify-center rounded-full bg-orange-100">
                        <X size={36} className="text-orange-500" /></div></div>
...
const MyBookings = () => {
    ...
    return (
        <div
            ...
            style={{
                background: "linear-gradient(to bottom, #FFA500, #FFFFFF, #32CD32)"}}>
            <div className="mb-6">
                <h1 className="text-2xl font-semibold">My Bookings</h1>
                <p className="text-sm text-green-950"><b>
                    View and manage all your ticket bookings</b></p></div>
                        ...
                        <div className="flex justify-between items-start mb-3">
                            <div>
                                <h2 className="font-semibold text-base">
                                    {booking.eventName}</h2>
                                <p className="text-xs text-gray-500">
                                    Booking ID: {booking.id}</p> </div>
                                    <span
