...
const Dashboard = () => {
    ...
    const loadEvents = async () => {
        ...
        const totalBookings = res?.data?.totalBookings || 0;
    ...
    return (
        <>
            <div
                ...
                style={{
                    background: "linear-gradient(to right, #014401, #edf1f8, #b47603)"}}>
                <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">

                    {/* Greeting */}
                    <div className="mb-10">
                        <h1 className="text-3xl font-bold text-gray-900">
                            Good day, Have a Great Day ahead {name}!
                        </h1>
                        <p className="text-green-550 mt-1">
                            Seamless train ticket booking for every journey!
                        </p></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                        {dashBoardStatasctics.map((stat) => (
                            <div
                                key={stat.id}
                                className={`p-6 rounded-2xl ${stat.bg} shadow-sm`}>
                                <div className="flex justify-between items-center mb-4">
                                    <div
                                        className={`w-12 h-12 ${stat.iconBg} text-white flex items-center justify-center rounded-xl`}>
                                        <Users size={20} />
                                    </div>
                    ...
                    <div className="flex items-center justify-between mb-5">
                        <div>
                            <h2 className="text-xl font-semibold">Popular Trips</h2>
                            <p className="text-blue-50 text-sm">Book your tickets now</p>
                        </div>
                        <button
                        ...
                        {events.map((event) => (
                            <div
                                ...
                                <div className="flex items-center justify-between border-t pt-4 mt-6">
                                    ...
                                    <button
                                        className="bg-blue-500 text-white px-6 py-2 rounded-full text-sm hover:bg-sky-600"
                                        onClick={() => {
