...
const Profile = () => {
    ...
    return (
        ...
        <div className="w-full min-h-screen flex justify-center items-start py-20 bg-gradient-to-r from-orange-400 via-green-200 to-green-100">
            {/* Gradient Border Wrapper */}
            <div className="p-[2px] rounded-2xl bg-gradient-to-r from-orange-500 to-green-500">
                {/* Inner Card */}
                <div className="max-w-xl mx-auto bg-white rounded-2xl shadow-sm p-5">
                    {/* Header */}
                    <div className="flex justify-between items-start">
                        ...
                        {isEditing ? (
                            <button
                                onClick={handleSave}
                                className="flex items-center gap-2 bg-green-900 text-white px-5 py-2 rounded-full hover:bg-green-600 transition">
                                <Save size={16} /> Save
                            </button>) : (
                            <button
                    ...
                    <div className="flex flex-col items-center text-center mt-5">
                        <div className="w-16 h-16 rounded-full bg-white-100 flex items-center justify-center">
                            <span className="text-xl font-bold bg-gradient-to-r from-orange-800 via-white to-green-800 bg-clip-text text-transparent text-center">
                                {user.initials}
                            </span></div>
                        ...
                        <div className="flex gap-2 mt-2">
                            <span className="px-3 py-1 rounded-full text-sm bg-orange-00 text-orange-600">
                                {user.role}
                            </span>
                        </div>
                    </div>
