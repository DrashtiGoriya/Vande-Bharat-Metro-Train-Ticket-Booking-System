...
export default function ManageBookings() {
    ...
    useEffect(() => {
        ...
        setFilteredBookings(temp);}, [searchTerm, statusFilter, eventFilter, bookings]);
    ...
    return (
        <div className="w-full p-6 bg-gray-50 min-h-screen">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-3xl font-bold text-orange-800">Manage Bookings</h1>
                <p className="text-green-900 mt-1"><u>
                    View, create, and manage all ticket bookings</u>
                </p>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3 w-full">
                    ...
                    {/* Search Icon */}
                        ...
                        <button className="cursor-pointer relative left-1 bg-gray-50 hover:bg-gray-50 rounded-full p-2 shadow-md transition">
                         <Search size={16} stroke="url(#search-gradient)" />
                         <svg width="0" height="0">
                         <linearGradient id="search-gradient" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <input
                        ...
                        className="px-5 py-2 pr-12 rounded-full border border-orange-200 bg-white shadow-sm w-72 focus:outline-none "
                        value={searchTerm}
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none px-5 py-2 pr-10 rounded-full border border-blue-200 bg-blue shadow-sm">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none px-5 py-2 pr-10 rounded-full border border-green-200 bg-white shadow-sm">
                ...
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        {filteredBookings.map((booking) => (
                            <tr
                                key={booking.id}
                                className="border-b-4 border-b-white last:border-b-0 bg-green-100 transition">
